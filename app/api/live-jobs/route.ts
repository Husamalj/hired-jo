...
async function fetchAllJobs(): Promise<Job[]> {
  // 4 broad regional queries. LinkedIn jobs come from the direct scraper
  // (/api/scrape-jobs), not JSearch — JSearch's Google-Jobs index has no
  // LinkedIn data for ME regions (verified: site:linkedin.com returns 0).
